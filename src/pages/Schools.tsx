...
function SchoolModal({
  ...
  async function uploadLogo(file: File) {
    try {
      ...
      if (!schoolId) {
        throw new Error('Save the school first, then upload the logo for that tenant.');
      }
              ...
              <div className="space-y-2">
                ...
                {isEdit ? (
                  <button
                    ...
                    className="btn-outline text-xs px-3 py-2 w-full sm:w-auto"
                  ...
                  <p className="text-xs text-ink-500">
                    Register the school first, then upload the logo for that tenant.
                  </p>
                )}
              </div>
